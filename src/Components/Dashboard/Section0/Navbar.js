...
function Navbar() {
    ...
    const logout = () => {
        axios.get("https://twitterserverharsh.herokuapp.com/logout")
            .then(() => {
                history.push("/")
            })
    }
            ...
            <nav class="navbar p-0" style={{ height: "100%", backgroundColor: "#F7F6F3" }}>
                ...
                <ul class="navbar-nav mx-auto mt-auto">
                    <li class="nav-item pb-2">
                        <img src={sessionStorage.getItem("profile_image_url")} alt="avatar" height="25vh" width="45vw"></img>
                    </li>
                    <li class="nav-item py-2">
                        <img src={setting} onClick={()=>logout()} alt="setting" height="25vh" width="45vw" style={{borderRadius: "50%",cursor:"pointer"}}></img>
                    </li>
